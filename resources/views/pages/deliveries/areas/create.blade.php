<x-app-layout>
    <div class="custom_form py-4 max-w-4xl mx-auto">
        <div class="header">
            ...
            <h2>New Delivery Area</h2>
        </div>

        <form action="{{ route('delivery-areas.store') }}" method="post">
            @csrf
            ...
            <div class="inputs">
                ...
                <select name="delivery_location_id" id="delivery_location_id">
                    ...
                    @foreach($locations as $location)
                        <option value="{{ $location->id }}" {{ old('delivery_location_id') == $location->id ? 'selected' : '' }}>{{ $location->location_name }}</option>
                    @endforeach
                </select>
            ...
            <div class="inputs">
                ...
                <input type="text" name="area_name" id="area_name" autocomplete="area_name" value="{{ old('area_name') }}" autofocus>
